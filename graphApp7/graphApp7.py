...
def update_figure(data):
    ...
    axes[0].plot(x, y, 'r-') # r -> red , - -> line style [[r, g], [-, *]]
...
window = sg.Window('Graph App', layout, finalize=True) #finalize=True  => To Marge The Two Windows [Interface, Graph]


# MatPlotLib
fig = plt.figure(figsize=(5, 4))   # matplotlib.figure.Figure(figsize = (5, 4))
